    ...
    <div class="navbar-header">
       ...
       <div class="container">
        <div class="row">
          ...
          <div class="row">
          <div class="col-md-12" id="ex3"><h1>Radial</h1>
            <table id="resultTable" class="table table-hover">
                   <thread>
                        <tr>
                          <th>Pos</th>
        ...
        <div class="row">
          <div class="col-md-12" id="ex3"><h1>4.7</h1>
            <table id="resultTable" class="table table-hover">
                   <thread>
                        <tr>
                          <th>Pos</th>
        ...
        <div class="col-md-12" id="bluDiv">
            <form class="form-horizontal" role="form" action="confirm.php" method="post" align="center">
