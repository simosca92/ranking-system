            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <tbody>
                 ...
                 require_once __DIR__ . '/db_connect.php';
                 $db = new DB_CONNECT();
                 $selezione=mysql_query("SELECT Nome,Cognome,Posizione FROM `Partecipante_temp` where Classe='4.7'order by Posizione,Nome") or die(mysql_error());
                 if(mysql_num_rows($selezione)>0){ 
                  ...
                  { 
                    ...
                    <form action=\"delete_part.php\" method=\"post\">
                        ...
                        <td> <button name=submit2 type=\"submit\" class=\"btn btn-warning btn-sm\"  onClick=\"return(confirm('Cancellare?'))\">-</button></td>
                        </tr>
                    </form>
                    ";
                    $a=$a+1;
      ...
      <form class="form-horizonatal" role="form" action="add_partecipante.php" method="post">
            ...
            <div  id="sovra" class="form-group">
              ...
              <div  class="col-sm-6">
                ...
                require_once __DIR__ . '/db_connect.php';
                $db22 = new DB_CONNECT();
                $selezione=mysql_query("SELECT MAX(Posizione) AS PosizioneMAX FROM `Partecipante_temp` where Classe='4.7' and  username='$_SESSION[cod]'") or die(mysql_error());
            ...
            <div   class="form-group">
             ...
             <button id="second" name="submit9"  type="submit" class="btn btn-primary">Indietro</button>
             <button id="third" name="submit3"  type="submit" class="btn btn-primary">Fine</button>
            </div>                          
          </form>
        </div>
      </div>
